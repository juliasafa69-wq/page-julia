  ...
  input.onchange = async function (e) {
    ...
    if (file) {
      try {
        ...
        `;
        loadingDiv.innerHTML = "⏳ Processando reel...";
        ...
        try {
          ...
          if (error) {
            console.warn("⚠️ Reel salvo apenas localmente:", error);
            alert(
              "⚠️ Reel adicionado, mas não foi salvo no servidor. Salvo apenas localmente."
            );
          } else {
            console.log("✅ Reel salvo no Supabase com sucesso!");
          }
        } catch (error) {
          console.error("❌ Erro ao salvar no Supabase:", error);
          alert(
            "⚠️ Reel adicionado localmente, mas não foi salvo no servidor."
          );
        }
        ...
        alert("✅ Reel adicionado com sucesso!");
      } catch (error) {
