    ...
    mediaContent.innerHTML = `
            <div class="media-viewer-container">
                ...
                <div class="media-display">
                    ...
                    <video src="${
                      media.src
                    }" ${isOwner ? 'controls' : ''} autoplay class="media-main-video" id="reelVideo" ${!isOwner ? 'controlsList="nodownload" oncontextmenu="return false;" onclick="toggleVideoPlayPause()"' : ''} style="${!isOwner ? 'cursor: pointer;' : ''}">
