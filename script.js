...
async function logoutAdmin() {
  ...
  try {
    ...
    // 2. SignOut do Supabase (com timeout)
    ...
    await Promise.race([signOutPromise, timeoutPromise]).catch(() => {
      console.log("⚠️ SignOut com erro, continuando...");
    });
  } finally {
    // 3. SEMPRE limpar localStorage E estado (mesmo com erro)
    ...
    // 4. Recarregar página (modo visitante)
