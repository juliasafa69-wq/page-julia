...
async function createPost() {
    ...
    if (imageFile) {
        ...
        // Adicionar à galeria de fotos PERMANENTEMENTE NO SUPABASE
        await savePhotoToGallery(Date.now() + 1, imageUrl, text || 'Foto do post', privacy);
    }
        ...
        if (file) {
            ...
            try {
                ...
                testImg.onload = function() {
                    ...
                    // Adicionar à galeria PERMANENTEMENTE NO SUPABASE  
                    await savePhotoToGalleryAsProfilePic(Date.now(), imageUrl, 'Nova foto de perfil', 'public');
