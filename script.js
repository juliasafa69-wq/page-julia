...
async function loadMessagesFromDB() {
  ...
  if (!isOwner) return; // Só admin carrega mensagens
...
async function sendMessageToJuliaFromChat(chatId) {
  ...
  try {
    // Usar ID fixo "admin" que é usado em outras partes do código
    const juliaId = "admin";
    console.log("👑 Enviando para Julia (recipient_id: admin)");
