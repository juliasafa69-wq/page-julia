...
async function sendFriendRequest() {
  ...
  if (authError || !user) {
    const authErrorMessage = currentLanguage === "es" ?
    ...
    requestsContainer.innerHTML = friendRequests
      .map((request) => {
        ...
        if (isOwner) {
            ...
            <div class="friend-request" id="request-${request.id}">
                ...
                <div class="request-info">
                    ...
                    <div class="request-actions">
                        <button class="btn btn-primary" onclick="acceptFriend('${request.id}', '${request.name}')">${t("accept")}</button>
                        <button class="btn btn-secondary" onclick="rejectFriend('${request.id}')">${t("decline")}</button>
                    </div>
                </div>
            </div>
          `;
          ...
          const pendingText = currentLanguage === "es" ? "Solicitud pendiente" : "Solicitação pendente";
          return `
            <div class="friend-request" id="request-${request.id}">
                <img src="${request.pic}" alt="${request.name}" class="request-pic">
                <div class="request-info">
